...
namespace HubCore\commands;
    ...
    {
        public function __construct(Main $main, string $name = 'addkarma', string $description = 'addkarma', string $usageMessage = null, array $aliases = []) {
